<?php
/**
 * OhmsImport_File class - represents a ohms file
 *
 * @copyright Copyright 2007-2012 Roy Rosenzweig Center for History and New Media
 * @license http://www.gnu.org/licenses/gpl-3.0.txt GNU GPLv3
 * @package OhmsImport
 */
class OhmsImport_File implements IteratorAggregate
{
    private $_filePath;
     ...
     * @param string|null $columnDelimiter Optional Column delimiter for the OHMS file.
     */
    ...
    public function getColumnNames() 
    {
        if (!$this->_columnNames) {
            throw new LogicException("OHMS file must be validated before "
    ...
    /**
     * Get an iterator for the rows in the OHMS file.
     * 
     * @return OhmsImport_RowIterator
     */
    public function getIterator()
    {
        if (!$this->_rowIterator) {
            $this->_rowIterator = new OhmsImport_RowIterator(
    ...
    public function parse()
    {
        ...
        try {
            ...
            return false;
        } catch (OhmsImport_MissingColumnException $e) {
            $this->_parseErrors[] = $e->getMessage()
                . ' ' . __('Please ensure that the OHMS file is formatted correctly'
