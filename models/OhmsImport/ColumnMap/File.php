<?php
/**
 * OhmsImport_ColumnMap_File class
 *
 * @copyright Copyright 2007-2012 Roy Rosenzweig Center for History and New Media
 * @license http://www.gnu.org/licenses/gpl-3.0.txt GNU GPLv3
 * @package OhmsImport
 */
class OhmsImport_ColumnMap_File extends OhmsImport_ColumnMap
{
    const FILE_DELIMITER_OPTION_NAME = 'ohms_import_file_delimiter';
    ...
    public function __construct($columnName, $fileDelimiter = null)
    {
        ...
        $this->_type = OhmsImport_ColumnMap::TYPE_FILE;
