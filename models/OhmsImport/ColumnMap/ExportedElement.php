<?php
/**
 * OhmsImport_ColumnMap_ExportedElement class - works with ohms files exported from another Omeka
 * installation using OHMS Report.  Differs from OhmsImport_ColumnMap_Element in the structure of 
 ...
 * @package OhmsImport
 */
class OhmsImport_ColumnMap_ExportedElement extends OhmsImport_ColumnMap 
{
    ...
    public function __construct($columnName)
    {
        ...
        $this->_type = OhmsImport_ColumnMap::TYPE_ELEMENT;
