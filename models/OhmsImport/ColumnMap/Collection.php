<?php
/**
 * OhmsImport_ColumnMap_Collection class
 *
 * @copyright Copyright 2007-2012 Roy Rosenzweig Center for History and New Media
 * @license http://www.gnu.org/licenses/gpl-3.0.txt GNU GPLv3
 * @package OhmsImport
 */
class OhmsImport_ColumnMap_Collection extends OhmsImport_ColumnMap 
{    
    /**
    ...
    public function __construct($columnName)
    {
        ...
        $this->_type = OhmsImport_ColumnMap::TYPE_COLLECTION;
    }
