<?php
/**
 * OhmsImport_ColumnMap_Tag class
 *
 * @copyright Copyright 2007-2012 Roy Rosenzweig Center for History and New Media
 * @license http://www.gnu.org/licenses/gpl-3.0.txt GNU GPLv3
 * @package OhmsImport
 */
class OhmsImport_ColumnMap_Tag extends OhmsImport_ColumnMap
{
    const TAG_DELIMITER_OPTION_NAME = 'ohms_import_tag_delimiter';
    ...
    public function __construct($columnName, $tagDelimiter = null)
    {
        ...
        $this->_type = OhmsImport_ColumnMap::TYPE_TAG;
