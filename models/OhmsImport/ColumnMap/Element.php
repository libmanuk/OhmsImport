<?php
/**
 * OhmsImport_ColumnMap_Element class
 *
 * @copyright Copyright 2007-2012 Roy Rosenzweig Center for History and New Media
 * @license http://www.gnu.org/licenses/gpl-3.0.txt GNU GPLv3
 * @package OhmsImport
 */
class OhmsImport_ColumnMap_Element extends OhmsImport_ColumnMap
{
    const ELEMENT_DELIMITER_OPTION_NAME = 'ohms_import_element_delimiter';
