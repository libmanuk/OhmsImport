<?php
/**
 * OhmsImport_RowIterator class
 *
 * @copyright Copyright 2007-2012 Roy Rosenzweig Center for History and New Media
 * @license http://www.gnu.org/licenses/gpl-3.0.txt GNU GPLv3
 * @package OhmsImport
 */
class OhmsImport_RowIterator implements SeekableIterator
{
    const COLUMN_DELIMITER_OPTION_NAME = 'ohms_import_column_delimiter';
    ...
    public function rewind()
    {
        ...
        if ($uniqueColCount != $this->_colCount) {
            throw new OhmsImport_DuplicateColumnException("Header row "
     ...
     * @throws OhmsImport_MissingColumnException
    ...
    protected function _formatRow($row)
    {
        ...
        if (count($row) != $this->_colCount) {
            ...
            throw new OhmsImport_MissingColumnException("Row beginning with "
    ...
    /**
     * Returns a file handle for the OHMS file.
     *
    ...
    /**
     * Returns the next row in the OHMS file.
     *
