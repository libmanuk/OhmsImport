<?php
/**
 * OhmsImport_ImportTask class
 *
 * @copyright Copyright 2007-2012 Roy Rosenzweig Center for History and New Media
 * @license http://www.gnu.org/licenses/gpl-3.0.txt GNU GPLv3
 * @package OhmsImport
 */
class OhmsImport_ImportTask extends Omeka_Job_AbstractJob
{
    const QUEUE_NAME = 'ohms_import_imports';
     ...
     * 
     * @return OhmsImport_Import The import of the import task
     */
    protected function _getImport()
    {
        return $this->_db->getTable('OhmsImport_Import')->find($this->_importId);
    }
}
